  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {open && (
        ...
        >
          <div className="px-4 py-3 border-b text-sm font-semibold text-slate-800">Todas las categorías</div>
          <ul className="max-h-[60vh] overflow-y-auto py-2">
            {CATEGORIES.map((c) => (
              <li key={c}>
                <a
                  href="#"
                  className="block px-4 py-2.5 text-[15px] text-slate-700 hover:bg-slate-50 hover:text-[var(--color-primary)]"
                >
                  {c}
                </a>
              </li>
