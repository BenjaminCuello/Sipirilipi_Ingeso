#!/usr/bin/env node
// Demo seeding with fresh catalog data
...
const unsplash = (size, terms) => `https://source.unsplash.com/${size}/?${terms}`
...
async function seedCatalog() {
  ...
  for (const item of products) {
    const categoryId = categoryIds.get(slugify(item.category)) ?? null
