// 🟢 CORRECCIÓN 1: Eliminamos 'Role' de la importación
...
async function seedUsers() {
    const users = [
        // 🟢 CORRECCIÓN 2: Usamos el string "CUSTOMER"
        { email: 'cliente@demo.com', name: 'Cliente Demo', password: 'secret12', role: 'CUSTOMER' },
        // 🟢 CORRECCIÓN 3: Usamos el string "SELLER"
        { email: 'vendedor@tienda.com', name: 'Vendedor Demo', password: 'password123', role: 'SELLER' },
    ]
